...
final class Version20190525133042 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO user (email, roles, password, name, surname, address, phone, bonuses,created_at,updated_at) VALUES('vetal1199@gmail.com',:roles,:pass,'Vitaliy','Gopkalo','Not','09545',2000,:dat,:up)", $data2);
    }
